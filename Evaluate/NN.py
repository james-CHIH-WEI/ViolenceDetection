...
def pre_train_model(data_folder):
    model_path = "./Export_data/" + data_folder + "/train/NN.m"
...
if __name__ == "__main__":
    ...
    if args.folder == "":
        ...
        NN = pre_train_model(data_folder)
        ...
        for action_type in action_types:
            ...
            folder_original_data = (
                "./Violence_data/" + folder_name + "/" + action_type + "_csv"
            )
            ...
            for file in os.listdir(folder_original_data):
                ...
                for index, result in df.iterrows():
                    ...
                    result_model_predict = NN.predict(result_test_df)[0]
